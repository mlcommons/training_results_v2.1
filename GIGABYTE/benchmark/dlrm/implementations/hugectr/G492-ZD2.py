...
from mlperf_logger.common import save_log_info
# 1. Create Solver, DataReaderParams and Optimizer
solver = hugectr.CreateSolver(max_eval_batches = 43,
                              batchsize_eval = 2073600,
                              batchsize = 51200,
...
reader = hugectr.DataReaderParams(data_reader_type = hugectr.DataReaderType_t.RawAsync,
                                  ...
                                  async_param = hugectr.AsyncParam(32, 2, 552960, 2, 512, True, hugectr.Alignment_t.Auto))
...
save_log_info(solver, 'dlrm.json')
# 5. Compile & Fit
model.compile()
model.summary()
