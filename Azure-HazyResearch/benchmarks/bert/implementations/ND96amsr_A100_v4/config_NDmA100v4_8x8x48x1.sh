...
export EXTRA_PARAMS="--dense_seq_output --last_layer_subset --unpad --exchange_padding --fused_bias_fc --fused_bias_mha --fused_bias_fc_loss_head --fused_dense_gelu_dense --fused_dropout_add_ln "
export PHASE=2
...
source $(dirname ${BASH_SOURCE[0]})/config_NDmA100v4_common.sh
