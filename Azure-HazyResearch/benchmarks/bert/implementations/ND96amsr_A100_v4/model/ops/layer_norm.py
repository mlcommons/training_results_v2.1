...
from apex.contrib.layer_norm.layer_norm import FastLayerNormFN, FastLayerNorm as FastLayerNormApex

# from apex._autocast_utils import _cast_if_autocast_enabled
import dropout_layer_norm


# TD [2022-05-31] We redefine this to not cast everything to fp16 in case of AMP
def _fast_layer_norm(x, weight, bias, epsilon):
    return FastLayerNormFN.apply(x, weight, bias, epsilon)


class FastLayerNorm(FastLayerNormApex):
