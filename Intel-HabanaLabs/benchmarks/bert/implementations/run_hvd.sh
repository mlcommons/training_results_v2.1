...
# to WA the error "TensorFlow device (XPU:0) is being mapped to multiple devices"
export USE_LIGHTWEIGHT_CHECKPOINT=False # True
...
# To fix error "ScopedAllocatorMgr not supported on device"
