source $(dirname ${BASH_SOURCE[0]})/config_RX2540M6_A30_common.sh
...
export EVAL_OFFSET="2" # Targeting epoch no. 35 2
...
export LRSCHED="pow2"
export NUMEPOCHS=${NUMEPOCHS:-"37"} #37
...
#export DALI_TMP_BUFFER_HINT="177784164" #"355568328" #871491*batch_size
#export DALI_NORMALIZE_BUFFER_HINT="441549" #401408*1.1

export HOROVOD_CYCLE_TIME=0.1
export HOROVOD_FUSION_THRESHOLD=67108864
export HOROVOD_NUM_NCCL_STREAMS=1 #1
...
export WALLTIME=06:00:00  #00:40:00
