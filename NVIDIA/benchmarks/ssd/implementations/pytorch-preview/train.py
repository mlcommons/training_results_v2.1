...
def main(args):
    ...
    # cuDNN runtime fusion of backbone can only come with --jit
    # TODO: fix, there is no real connection between the two
    assert((args.apex_backbone_fusion and args.jit) or not args.apex_backbone_fusion)
