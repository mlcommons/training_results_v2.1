...
class MaskRCNNC4Predictor(nn.Module):
    def __init__(self, cfg):
        ...
        mllogger.event(mllogger.constants.WEIGHTS_INITIALIZATION, metadata=dict(tensor='ROI_MASK_PREDICTOR_fcn5'))
        mllogger.event(mllogger.constants.WEIGHTS_INITIALIZATION, metadata=dict(tensor='ROI_MASK_PREDICTOR_fcn_logits'))
