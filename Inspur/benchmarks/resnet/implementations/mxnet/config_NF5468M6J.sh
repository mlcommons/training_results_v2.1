source $(dirname ${BASH_SOURCE[0]})/config_NF5468M6J_common.sh

## DL params
export OPTIMIZER="sgdwfastlars"
export BATCHSIZE="136"
...
export DALI_THREADS="11"
export DALI_PREFETCH_QUEUE="13"
export DALI_NVJPEG_MEMPADDING="256"
export DALI_HW_DECODER_LOAD="0.6"
export DALI_CACHE_SIZE="0"
export DALI_ROI_DECODE="1"

#for DALI eval
export DALI_EVAL_THREADS="5"
export DALI_EVAL_PREFETCH_QUEUE="6"
export DALI_EVAL_HW_DECODER_LOAD="0.6"
