...
export BATCHSIZE=6
export EXTRA_PARAMS=""
export EXTRA_CONFIG='SOLVER.BASE_LR 0.16 SOLVER.WARMUP_FACTOR 0.000256 SOLVER.WARMUP_ITERS 625 SOLVER.WARMUP_METHOD mlperf_linear SOLVER.STEPS (9000,12000) SOLVER.IMS_PER_BATCH 144 TEST.IMS_PER_BATCH 144 MODEL.RPN.FPN_POST_NMS_TOP_N_TRAIN 6000 MODEL.RPN.FPN_POST_NMS_TOP_N_PER_IMAGE False NHWC True MODEL.RESNETS.FIRST_TRANS_FUNC BottleneckWithFixedBatchNorm MODEL.RESNETS.TRANS_FUNC FastBottleneckWithFixedBatchNorm'
