...
# assign gpus to rank
RANK="${LOCAL_RANK:=${SLURM_LOCALID:=${OMPI_COMM_WORLD_LOCAL_RANK:-}}}"
RANK_GPU_INDEX=$(( RANK % DGXNGPU ))
export CUDA_VISIBLE_DEVICES=$RANK_GPU_INDEX

#bind_cpu_cores=([0]="0-15,128-143" [1]="48-63,176-191" [2]="16-31,144-159" [3]="32-47,160-175" [4]="64-79,192-207" [5]="112-127,240-255" [6]="80-95,208-223" [7]="96-111,224-239")
#bind_cpu_cores=([0]="48-63" [1]="16-31" [2]="112-127" [3]="80-95")
bind_cpu_cores=([0]="32-63" [1]="0-31" [2]="96-127" [3]="64-95")

numactl --physcpubind=${bind_cpu_cores[${RANK_GPU_INDEX}]}  python3 ./ml_perf/train_loop.py \
        --board_size=19 \
        --base_dir=$BASE_DIR \
