...
#_cont_mounts=("--volume=${DATADIR}:/data" "--volume=${LOGDIR}:/results" "--volume=${PWD}:/opt/reinforcement" "--volume=${DATADIR}/scratch/${DATETIME}:/opt/reinforcement/minigo/ml_perf/mpi-results")
