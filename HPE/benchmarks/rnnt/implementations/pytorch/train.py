...
def main():
    ...
    logging.log_event(logging.constants.SUBMISSION_ORG, value='HPE')
    ...
    logging.log_event(logging.constants.SUBMISSION_PLATFORM, value=f'HPE-ProLiant-XL675d-Gen10-Plus_A100-SXM-80GB_x{num_nodes}')
