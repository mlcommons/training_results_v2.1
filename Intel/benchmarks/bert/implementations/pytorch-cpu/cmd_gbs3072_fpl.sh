...
params="--train_batch_size=${LBS}    --learning_rate=2.4e-3     --opt_lamb_beta_1=0.69     --opt_lamb_beta_2=0.998     --warmup_proportion=0.0     --warmup_steps=0.0     --start_warmup_step=0     --max_steps=867   --phase2    --max_predictions_per_seq=76      --do_train     --skip_checkpoint     --train_mlm_accuracy_window_size=0     --target_mlm_accuracy=0.720     --weight_decay_rate=0.01     --max_samples_termination=4500000     --eval_iter_start_samples=175000 --eval_iter_samples=175000     --eval_batch_size=16  --gradient_accumulation_steps=1     --log_freq=0 "
