...
mkdir -p ${OUTPUT_DIR}
LOG=${OUTPUT_DIR}/dlrm_training_log_32k_4node/${PRECISION}
rm -rf ${LOG}
mkdir -p ${LOG}
...
scontrol show hostname $SLURM_NODELIST >hostfile_4
cat hostfile_4
export MASTER_ADDR=$(head -1 hostfile_4)
