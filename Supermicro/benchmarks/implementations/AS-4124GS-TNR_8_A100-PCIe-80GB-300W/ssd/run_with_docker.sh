...
# Mount points
CONT_MOUNTS=(
    "--volume=/home/smci/Kevin/MLPerf-Training-v2.1/mlperf-train/ssd/data:/datasets/open-images-v6"
    "--volume=${LOGDIR}:/results"
    "--volume=${BACKBONE_DIR}:/torch-home"
...
# readonly TORCH_RUN="LD_PRELOAD=/usr/lib/x86_64-linux-gnu/libjsoncpp.so python -m torch.distributed.run --standalone --no_python"
