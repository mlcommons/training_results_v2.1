...
: "${DATADIR:=/home/smci/Kevin/MLPerf-Training-v2.1/mlperf-train/bert/data/hdf5/training-4320/hdf5_4320_shards_varlength}"
: "${DATADIR_PHASE2:=/home/smci/Kevin/MLPerf-Training-v2.1/mlperf-train/bert/data/hdf5/training-4320/hdf5_4320_shards_varlength}"
: "${CHECKPOINTDIR_PHASE1:=/home/smci/Kevin/MLPerf-Training-v2.1/mlperf-train/bert/data/phase1}"
: "${EVALDIR:=/home/smci/Kevin/MLPerf-Training-v2.1/mlperf-train/bert/data/hdf5/eval_varlength}"
: "${UNITTESTDIR:=}"
: "${LOGDIR:=/home/smci/Kevin/MLPerf-Training-v2.1/mlperf-train/bert/logs}"
...
# Setup container
nvidia-docker run --rm --init --detach --gpus=all \
