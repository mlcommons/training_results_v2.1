...
_cont_mounts=("--volume=/mlperf/training-2.1/dlrm/scripts:/workspace/dlrm" "--volume=${DATADIR}:/raid/datasets/criteo/mlperf/40m.limit_preshuffled/" "--volume=${LOGDIR}:${LOGDIR}")
