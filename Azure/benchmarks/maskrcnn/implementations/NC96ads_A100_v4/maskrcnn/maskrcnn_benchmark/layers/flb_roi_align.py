...
class _FLBROIAlign(Function):
    ...
    def backward(ctx, grad_output):
        ...
        grad_inputs = _C.flb_roi_align_backward(
            grad_output, rois_counts, rois, level,
        ...
        grad_inputs = [x.to(dtype=grad_output.dtype) for x in grad_inputs]
        return grad_inputs[0], grad_inputs[1], grad_inputs[2], grad_inputs[3], None, None, None, None, None, None, None
