...
_cont_mounts=("--volume=${DATADIR}:/data" "--volume=${LOGDIR}:/results" "--volume=/opt/microsoft/ncv4/topo.xml:/opt/microsoft/ncv4/topo.xml" "--volume=/opt/microsoft/ncv4/graph.xml:/opt/microsoft/ncv4/graph.xml" "--volume=/usr/lib/x86_64-linux-gnu/libnccl.so:/usr/lib/x86_64-linux-gnu/libnccl.so" "--volume=/usr/include/nccl.h:/usr/include/nccl.h")
...
for _experiment_index in $(seq 1 "${NEXP}"); do
	...
	#echo "HEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEERE"
        # Print system info
