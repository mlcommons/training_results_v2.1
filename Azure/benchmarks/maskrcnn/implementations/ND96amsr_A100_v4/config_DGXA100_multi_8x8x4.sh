...
## DL params
export EXTRA_PARAMS=""
export EXTRA_CONFIG='SOLVER.BASE_LR 0.24 SOLVER.WARMUP_FACTOR 0.000133 SOLVER.WARMUP_ITERS 1800 SOLVER.WARMUP_METHOD mlperf_linear SOLVER.STEPS (5625,7500) SOLVER.IMS_PER_BATCH 256 TEST.IMS_PER_BATCH 256 MODEL.RPN.FPN_POST_NMS_TOP_N_TRAIN 1000 MODEL.RPN.FPN_POST_NMS_TOP_N_PER_IMAGE True NHWC True'
