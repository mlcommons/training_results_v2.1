...
def make_data_loader(cfg, is_train=True, is_distributed=False, start_iter=0, random_number_generator=None, seed=41, shapes=None, hybrid_dataloader=None, H_split=True):
    ...
    transforms = build_transforms(cfg, is_train, is_fp16, is_hybrid_loader)
    ...
    datasets, epoch_size = build_dataset(dataset_list, None if is_hybrid_loader else transforms, DatasetCatalog, is_train)
