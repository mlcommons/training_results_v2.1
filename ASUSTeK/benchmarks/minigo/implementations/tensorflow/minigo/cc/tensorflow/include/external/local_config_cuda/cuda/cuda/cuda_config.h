...
#define TF_CUDA_CAPABILITIES CudaVersion("5.2"), CudaVersion("6.0"), CudaVersion("6.1"), CudaVersion("7.0"), CudaVersion("7.5"), CudaVersion("8.0"), CudaVersion("8.6"), CudaVersion("9.0")
